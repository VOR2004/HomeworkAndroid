...
import ru.itis.graphic.presentation.screens.CustomViewScreen
    ...
    NavHost(navController = navController, startDestination = Routes.Main) {
        composable<Routes.Main> { backStackEntry ->
            MainScreen(
                ...
                onGraphButtonClick = {
                    navController.navigate(Routes.CustomView)
                })
        }
        ...
        composable<Routes.CustomView> {
            CustomViewScreen(onBack = { navController.popBackStack() })
        }
    }
}